...
var/global/list/playable_species = list(SPECIES_HUMAN, SPECIES_SKRELL, SPECIES_UNATHI, SPECIES_TAJ, SPECIES_DIONA)    // A list of ALL playable species, whitelisted, latejoin or otherwise.
